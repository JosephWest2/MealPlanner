...
export default async function RecipeComponent({
    ...
    return (
        <div className={styles.recipeGrid + " box"}>
            ...
            <div className={styles.info + " column"}>
                <p>
                    ...
                    {recipeData.readyInMinutes.toString()} minutes
                </p>
                <p>
                    <b>Servings:</b> {recipeData.servings.toString()}
                </p>
                <p>
                    <b>Serving size:</b>{" "}
            ...
            <div className={styles.summary}>
                {ProcessSummary(recipeData.summary)}
            </div>
            <Link
