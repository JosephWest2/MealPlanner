    ...
    providers: [
        {
            ...
            authorization: { url: "https://api.kroger.com/v1/connect/oauth2/authorize", params: { scope: "profile.compact product.compact cart.basic:write", redirect_uri: "https://meal2cart.com/api/auth/callback/kroger" } },
