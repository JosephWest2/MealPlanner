...
export default function Location() {
    ...
    return (
        <div className="box column" style={{ width: "fit-content" }}>
            ...
            {storeOptions && (
                <>
                    ...
                    >
                        <h3 style={{ color: "grey", gridColumn: "span 2" }}>
                            Ingredient filters:
                        </h3>
                        ...
                        <input
                            type="checkbox"
                            checked={ais}
                            onChange={(e) => setAis(e.target.checked)}
                        />
                        <p>Curbside pickup</p>
                        <input
                            type="checkbox"
                        ...
                        <input
                            type="checkbox"
                            checked={dth}
                            onChange={(e) => setDth(e.target.checked)}
                        />
                    </div>
